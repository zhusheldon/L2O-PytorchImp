...
dataset_train_file = cur_dir + "/trainset.pkl"
dataset_test_file = cur_dir + "/testset.pkl"

if os.path.isfile(dataset_train_file):
...
POLICY_PATH = EXP_DIR + 'data_files/policy_itr_' + POLICY_ITR + '.pkl'
...
common = {
    ...
    'policy_filename': POLICY_PATH,
    'test_log': EXP_DIR + 'test_log.txt',
    'conditions': num_fcns,
    'test_conditions': testnum_fcns,
    'testing': True
}
...
agent = {
    ...
    'fcns': testfcns if common['testing'] else fcns,
    'fcn_family': testfcn_family if common['testing'] else fcn_family,     # Only used to destroy these at the end
...
algorithm = {
    'type': Algorithm,
    'conditions': common['conditions'],
    'iterations': 100, #100 for testing
    'inner_iterations': 4,
